      ...
      <div className="flex flex-col gap-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold dark:text-white font-poppins">Notifications</h1>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          <Card className="md:col-span-2 dark:bg-gray-800 dark:border-gray-700 border-gray-200 shadow-sm">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-xl dark:text-white font-poppins">All Notifications</CardTitle>
              ...
              <Tabs defaultValue="all" onValueChange={setSelectedTab}>
                <TabsList className="grid w-full grid-cols-5 bg-gray-100 dark:bg-gray-700/50">
                  <TabsTrigger
                    value="all"
                ...
                <div className="flex items-center justify-between p-4 border-b dark:border-gray-700 border-gray-200">
                  <div className="flex items-center">
                    <Checkbox
                      ...
                      className="mr-2 dark:border-gray-600 border-gray-300"
                    />
                    <span className="text-sm font-medium dark:text-gray-300">Select All</span>
                  </div>
                  <Select defaultValue="newest">
                    <SelectTrigger className="w-[180px] h-8 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 bg-gray-50 border-gray-200">
                        ...
                        >
                          <div className="flex items-start gap-3">
                            <Checkbox
                              ...
                              className="mt-1 dark:border-gray-600 border-gray-300"
                            />
                            <div
          ...
          <Card className="md:col-span-1 dark:bg-gray-800 dark:border-gray-700 border-gray-200 shadow-sm">
            <CardHeader>
              <CardTitle className="dark:text-white font-poppins">Notification Settings</CardTitle>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Select defaultValue="daily">
                      <SelectTrigger className="w-[140px] dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 bg-gray-50 border-gray-200">
            ...
            <CardFooter>
              <Button className="w-full bg-purple-600 hover:bg-purple-700 font-medium">Save Preferences</Button>
            </CardFooter>
          </Card>
        </div>
      </div>
